        ...
        <div class="row flex-grow">
          <div class="col-lg-6 d-flex align-items-center justify-content-center">
            <div class="auth-form-transparent text-left p-3">
              ...
              <img src="{{asset('storage/images/'.$set->logo)}}" alt="logo" style="float: left; width: 90px; height: 70px;border-radius:8px;">   {!! "&nbsp;" !!} {!! "&nbsp;" !!}       	      
              <h3 class="navbar-brand" href="/" style="position: relative; top: 50%; bottom: 50%;left:2px;font-size:50px;">{{$set->nameweb}}</h3>
          ...
          <div class="col-lg-6 login-half-bg d-flex flex-row">
            <p class="text-white font-weight-medium text-center flex-grow align-self-end">Copyright &copy; 2021 Mastermind  All rights reserved.</p>
          </div>
        </div>
      </div>
