...
class TicketController extends Controller
{
    ...
    static function ticketassignedtoUser(){
        return ticket::where('ticket.status','Open')->where('ticket.assignedto',Auth::user()->id)->count();
      }
      static function ticketpendingtoTech(){
        return ticket::where('ticket.status','Pending')->where('ticket.assignedto',Auth::user()->id)->count();
      }
      static function ticketsolvedtoTech(){
        return ticket::where('ticket.status','Resolved')->where('ticket.assignedto',Auth::user()->id)->count();
      }
